...
public class RobotContainer {
    ...
    private final SwerveRequest.FieldCentricFacingAngle snap = new SwerveRequest.FieldCentricFacingAngle().withDriveRequestType(DriveRequestType.Velocity).withForwardPerspective(ForwardPerspectiveValue.BlueAlliance);
    ...
    public RobotContainer() {
        ...
        snap.HeadingController.setP(0.1);

        SmartDashboard.putData("pid", snap.HeadingController);
    }
