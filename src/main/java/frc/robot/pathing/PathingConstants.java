...
public class PathingConstants {
    public static final double kP_X = 10;
    public static final double kI_X = 0;
    public static final double kD_X = 0;

    public static final double kP_Y = 10;
    public static final double kI_Y = 0;
    public static final double kD_Y = 0;

    public static final double kP_THETA = 0.1;

    public static final double kErrorTolerance_X = Units.inchesToMeters(0.5);
    public static final double kErrorTolerance_Y = Units.inchesToMeters(0.5);

    public static final double kErrorToleranceDerivative_X = 0.1;
    public static final double kErrorToleranceDerivative_Y = 0.1;

    public static final double kPositionTolerance_Theta = 0.5; // degrees
